        ...
        <div> 
            ...
            <form className="text-center border border-dark p-5"  onSubmit={cseguro}>
                <label className="custom-control">Marca</label>
                    ...
                    <label className="custom-control">Año</label>
                        ...
                        <div className="custom-control custom-radio custom-control-inline">
                            ...
                            <br/><br/><br/>
                      <button type="submit" className="btn btn-block btn-outline-dark">Solicitar cotizacion  <i class="fas fa-file-alt fa-2x"></i></button>
              </form>
        </div>
     );
}
