        ...
        <br/><br/>
            <div className="row"> 
                ...
                <form className="col card mb-5 pt-5  fondo1 text-white font-weight-bold" onSubmit={buscarInfo}>
                          <fieldset className="text-center display-3 font-weight-bold">Busqueda de letras 
                          <br/><br/>
                           <div className="row">
                           ...
                           <br/>
                              <button type="submit" className="btn colorbtn btn-floating  float-right"><i className="fas fa-search fa-2x text-white"></i></button>
                           </fieldset>
                </form>
